...
---
<div class="pub-filter-toolbar" role="group" aria-label="Filter publications by category">
  <button type="button" class="pub-filter-btn is-active" data-pub-filter="all">All</button>
  <button type="button" class="pub-filter-btn" data-pub-filter="preprints">Preprints</button>
  <button type="button" class="pub-filter-btn" data-pub-filter="lecture notes">Lecture Notes</button>
  <button type="button" class="pub-filter-btn" data-pub-filter="journal papers">Journal</button>
  <button type="button" class="pub-filter-btn" data-pub-filter="conference papers">Conference</button>
  <button type="button" class="pub-filter-btn" data-pub-filter="phd thesis">Thesis</button>
</div>
...
<li>
 A. Rodriguez, A. Lancho, A. Weiss, “Learning to Separate RF Signals Under Uncertainty: Detect-Then-Separate vs. Unified Joint Models,” accepted at <em>IEEE Int. Conf. Commun.</em> (ICC), Glasgow, Scotland, UK, May 2026.
 <a href="https://arxiv.org/abs/2602.04650">arXiv</a>
</li><hr>

<li>
 M. Martinez-Garcia, R. Vazquez Alvarez, A. Lancho, P. M. Olmos, I. Valera, “A Probabilistic Hard Concept Bottleneck for Steerable Generative Models,” accepted at <em>Int. Conf. Learn. Representations</em> (ICLR), Rio de Janeiro, Brazil, 2026.
